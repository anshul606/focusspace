...
(() => {
  ...
  function createCongratulationsOverlay(durationMinutes, blockedAttempts) {
    removeBlockingOverlay();
  ...
  `;
    const title = document.createElement("h1");
    title.className = "flow-overlay-title";
    title.textContent = "\u{1F389} Session Complete!";
    const message = document.createElement("p");
    message.className = "flow-overlay-message";
    message.textContent = "Congratulations! You stayed focused and finished your session.";
  ...
  `;
    const encouragement = document.createElement("p");
    encouragement.className = "flow-overlay-encouragement";
    encouragement.textContent = "Great work! Keep up the momentum! \u{1F680}";
    contentContainer.appendChild(icon);
    contentContainer.appendChild(title);
    contentContainer.appendChild(message);
  ...
  function removeCongratulationsOverlay() {
